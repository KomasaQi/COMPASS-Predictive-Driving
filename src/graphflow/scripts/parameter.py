...
def parse_args():
    ...
    # 训练设置
    parser.add_argument('--exp_name', type=str, default='Exp_ploynomer_1step_fit_all_tensorboard', help='Name of the experiment')
    ...
    parser.add_argument('--occ_loss_weight', type=float, default=0.4, help='Weight of other vehicles occupancy loss')
    parser.add_argument('--spd_loss_weight', type=float, default=0.5, help='Weight of speed loss')          # 非0~1
    parser.add_argument('--acc_loss_weight', type=float, default=0.5, help='Weight of acceleration loss')   # 非0~1
    parser.add_argument('--head_loss_weight', type=float, default=0.1, help='Weight of heading loss')       # 非0~1
    parser.add_argument('--vtype_loss_weight', type=float, default=0.5, help='Weight of vehicle type loss') # one-hot-15分类
    parser.add_argument('--route_loss_weight', type=float, default=0.5, help='Weight of route loss')        # one-hot-4分类
