classdef VehicleSignalLight
    properties
        ...
        displeft = [-7.65,0.25,0];%[-1.15,0,0];
        dispright = [-7.65,-0.25,0];
    end
    methods
        function obj = VehicleSignalLight(varargin)
            ...
            obj.brkShape_left = obj.brkShape_left.*s+obj.displeft;
            obj.brkShape_right = obj.brkShape_right.*s+obj.dispright;
            obj.tlShape_left = obj.tlShape_left.*s+obj.displeft;
            obj.tlShape_right = obj.tlShape_right.*s+obj.dispright;
