...
class CompassParallelEnv(gym.Env): 
    """_summary_
    # Compass Highway Environment -- a Parallel Version
    ...
    def default_config(self) -> dict:
        config = {
            ...
            "simulation":{
                ...
                "traci_port": 8813,          # 新增：默认端口（会被并行时覆盖）
                "traci_label": None,         # 新增：默认None，reset时生成或由外部传入  
            },
            "gui":{
                "view": "View #0",
                "schema": "real world",
