...
s = s.addVehicle(Vehicle4COMPASS('L',17,'delta',1.5,'route',ego.route, ...
    'a_max',1.5,'b_comf',1,'routeIdx',ego.routeIdx,'routeNum',length(ego.route), ...
    'edgeID',ego.edgeID,'laneID',ego.laneID,'color',ego.sumo_params.color),egoState);
